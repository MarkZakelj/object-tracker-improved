...
# Online Classification influence
__C.TRACK.ONLINE_CLASSIFICATION_INFLUENCE = 0.4
...
__C.TRACK.WINDOW_INFLUENCE_SLOW = 0.30

__C.TRACK.WINDOW_INFLUENCE_FAST = 0.03

__C.TRACK.WINDOW_INFLUENCE_MEDIUM = 0.15

__C.TRACK.MEM_STEP = 5

__C.TRACK.MEM_LEN = 5

__C.TRACK.ST_MEM_COEF = 0.5

__C.TRACK.MEM_SINK_IDX = 1

__C.TRACK.SPEED_LAST_CALC = 3

__C.TRACK.SCORE_INSIDE_WIDTH = 11

__C.TRACK.SCORE_OUTSIDE_WIDTH = 23
